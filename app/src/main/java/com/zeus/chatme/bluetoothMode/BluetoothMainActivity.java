...
import com.zeus.chatme.bluetoothMode.fragments.ConversationFragment;
import com.zeus.chatme.bluetoothMode.fragments.PairingFragment;
    ...
    public void onBackPressed() {
        ...
        if (fragment != null) {
            if (fragment instanceof ConversationFragment) {
                ...
                startActivity(new Intent(BluetoothMainActivity.this, ChatHomeActivity.class));
                finish();
                Animatoo.animateSlideRight(BluetoothMainActivity.this);
            }
        } else {
            startActivity(new Intent(BluetoothMainActivity.this, ChatHomeActivity.class));
            finish();
